...
public class CardPlay {
	...
	public static void main(String[] args) {
		...
		Card [] player1 = new Card[numOfCard];
		Card [] player2 = new Card[numOfCard];
		Card [] player3 = new Card[numOfCard];
		Card [] player4 = new Card[numOfCard];
		
		// 1명당 5장씩 분배하고 1명당 한줄에 보유카드를 한번에 출력해서 4줄을 출력하세요
		int cardIndex = 0;
		...
		// "패키지이름.클래스이름@해쉬코드"가 출력되는 것이 아니라
		// toString() 메서드가 리턴해주는 String 값이 출력됩니다.
		System.out.println(c1);
		System.out.println(c2);
		// 이것은 참조변수 단독으로 사용되기 보단 다른연산에 참조변수가 참여하고 있을때 적용되는 규칙입니다.
